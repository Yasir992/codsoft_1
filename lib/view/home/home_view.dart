                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(MyString.mainTitle, style: TextStyle(fontSize: 30,color: Colors.black,fontWeight: FontWeight.bold)),
                        const SizedBox(
                          height: 2,
                        ),
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text("Yasir EJaz", style: textTheme.headlineLarge),
            Text("junior flutter dev", style: textTheme.headlineSmall),
            Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              const Text('ToDoTask',style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,color: Colors.black),),
